  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-primary-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <motion.h1 className="text-5xl font-bold bg-gradient-to-r from-primary-600 via-accent-600 to-purple-600 bg-clip-text text-transparent mb-6">
            About Vayal Agro
          </motion.h1>
        ...
        >
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-3xl shadow-xl border border-gray-100">
            ...
            <div className="flex justify-center">
              <div className="w-full max-w-md aspect-[9/16] rounded-2xl overflow-hidden shadow-lg">
                <iframe
        ...
        >
          ...
          >
            ...
            <p className="text-lg text-gray-700 leading-relaxed text-center max-w-4xl mx-auto">
              ...
              efficient solutions that reduce manual labor while maximizing productivity.
            </p>
          </motion.div>
        </motion.section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-primary-700">
                  {member.name}
                </h3>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <motion.div variants={itemVariants}
              ...
              <a href="mailto:jarvisbot2026@gmail.com"
                className="text-xl font-bold text-primary-600 break-all">
